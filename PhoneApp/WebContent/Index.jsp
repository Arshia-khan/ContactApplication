...
<body>
    ...
    <nav class="navigation">
        <div>
            <a href="Display.jsp"><button class="nav-buttons">All Contacts</button></a>
        </div>
        <div>
            <a href="Searchfrontend.jsp"><button class="nav-buttons">Search Contact</button></a>
        </div>
        <div>
            <a href="InsertFrontend.jsp"><button class="nav-buttons">Add Contact</button></a>
        </div>
